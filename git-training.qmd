...
-   **Track changes** (*commits*) over time with information about **who**, **when** and **what** are the changes

-   Eventually go **back in time**

-   **Highlight a specific version** of the project (*tags*). For example, new software versions.

-   **Synchronize** the project in the **cloud** with remote servers (GitHub, Gitlab)

-   **Resolve version conflict** when simultaneous changes

-   Create **derivates** of a project (*branches*): production, development, feature
