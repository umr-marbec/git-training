...
It is possible to tell Git to ignore some files by using a [.gitignore](https://git-scm.com/docs/gitignore) file (for instance, `.Rdata` or `.tmp` files).
...
::: callout-tip
To create a Git repository from scratch the easy way, create the repository on GitHub with a `README.md`. Local and remote repositories and branches are automatically synchronized!
:::
