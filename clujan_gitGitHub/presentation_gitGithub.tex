...
\begin{frame}[fragile]
    ...
    In this example, the \emph{master} branch points to the \verb+f30ab+ commit, while the \emph{testing} branch points to the \verb+c2b9e+ one.
...
\begin{frame}[fragile]
    ...
    \begin{center}
        \begin{figure}
            ...
            \caption{Merging \emph{experiment} into \emph{master}}
        \end{figure}
    \end{center}
