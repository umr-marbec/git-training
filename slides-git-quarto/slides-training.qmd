...
The `merge` command puts the commits from the argument branch (here `develop`) and puts them into the current branch (here master).#
...
**Order matters: it shows what has been added to `master` branch compared to the `develop` branch**

```{mermaid}
%%| fig-width: 10.5
%%| fig-height: 1
flowchart LR  
  id1(Develop)-->|git diff| id2(Master)
classDef workspace fill:lightgray,stroke:black,color:black
classDef index fill:lightblue,stroke:black,color:black
classDef local fill:lightgreen,stroke:black,color:black
classDef remote fill:yellow,stroke:black,color:black
...
%%| fig-height: 1
flowchart LR  
  id1(eb8fed1)-->|git diff| id2(Master)
classDef workspace fill:lightgray,stroke:black,color:black
classDef index fill:lightblue,stroke:black,color:black
classDef local fill:lightgreen,stroke:black,color:black
classDef remote fill:yellow,stroke:black,color:black
